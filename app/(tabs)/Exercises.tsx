...
const ExercisesScreen = ({ navigation }) => {
  ...
  const categories = [
    ...
    { id: "back", name: "Back", icon: "body", count: 5, color: "#44B8F3" },
    { id: "neck", name: "Neck", icon: "body", count: 3, color: "#44B8F3" },
    { id: "wrist", name: "Wrist", icon: "body", count: 2, color: "#44B8F3" },
  ];
        ...
        <View style={styles.header}>
          <View>
            ...
            <Text style={styles.subtitle}>
              Your personalized therapy exercises
            </Text>
          </View>
          <TouchableOpacity
          ...
          {filteredExercises.map((exercise) => (
            ...
            >
                  ...
                  <View style={styles.exerciseTitleRow}>
                    ...
                    >
                      <Ionicons
                        ...
                        size={22}
                        color={
                          favorites.includes(exercise.id) ? "#FF6B6B" : "#999"
                        }
                      />
                    </TouchableOpacity>
                  </View>
              ...
              <View style={styles.exerciseFooter}>
                ...
                >
                  <Text
                    style={[styles.categoryText, { color: exercise.color }]}
                  >
                    {exercise.category}
                  </Text>
                </View>
                ...
                <View style={styles.actionButtons}>
                  {exercise.completed ? (
                    ...
                    >
                      ...
                      />
                      <Text
                        style={[styles.completedText, { color: "#38B000" }]}
                      >
                        Completed
                      </Text>
                    </View>
              ...
              <View style={styles.featuredContent}>
                <View>
                  ...
                  <Text style={styles.featuredDescription}>
                    Comprehensive routine for overall flexibility and joint
                    health
                  </Text>
                </View>
